...
MAIN_PATHS: dict[str, str] = {
    ...
    "automation-one-latest-news.html": "/latest-news",
    "automation-one-latest-news-canon.html": "/latest-news/canon",
    "automation-one-latest-news-xerox.html": "/latest-news/xerox",
    "automation-one-latest-news-lexmark.html": "/latest-news/lexmark",
    "automation-one-latest-news-fp.html": "/latest-news/fp",
    "automation-one-latest-news-ideal-mbm.html": "/latest-news/ideal-mbm",
    "automation-one-latest-news-industry.html": "/latest-news/industry",
